...
define_hls_module GBFilter ../GBFilter.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config GBFilter BASIC
define_hls_config GBFilter DPA       --dpopt_auto=op,expr
define_hls_config GBFilter MEM
...
define_sim_config V_BASIC "GBFilter RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "GBFilter RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
